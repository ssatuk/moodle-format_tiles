...
class inline_css_output implements \renderable, \templatable {
    ...
    public function export_for_template(\renderer_base $output) {
        ...
        if ($this->allowphototiles) {
            ...
            $outputdata['phototiletextpadding'] = number_format((float)get_config('format_tiles', 'phototitletitlepadding') / 10, 1);
            $outputdata['phototiletextlineheight'] = number_format((float)get_config('format_tiles', 'phototitletitlelineheight') / 10, 1);
        }
